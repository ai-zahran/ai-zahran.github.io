...
date: 2018-06-28
description: "Sixth week coding my Google Summer of Code project with Red Hen Lab. I decided to use the time to go into the dialect identification task while the training…"
...
<p class="caption">Table 1: MGB-3 Arabic dialect identification data</p>
...
<figure>
  <img src="/assets/images/2018-06-24-Week-7-Dialect-Identification/siamese_neural_network.png" alt="Figure 1: Siamese neural network architecture of the MIT-QCRI system">
  <figcaption>Figure 1: Siamese neural network architecture of the MIT-QCRI system</figcaption>
</figure>
