...
date: 2018-08-13
description: "In this post, we will summarize the work done on Arabic speech recognition and Arabic dialect identification projects for RedHenLab as part of GSoC 2018. Each of…"
...
## [Arabic Speech Recognition](/blog/arabic-asr/)
...
Check this [post](/blog/arabic-asr/) for more information about the project.
...
## [Arabic Dialect Identification](/blog/arabic-di/)
...
Check this [post](/blog/arabic-di/) for more details about the project.
...
## Timeline
 ...
 - [Spending this summer in GSoC with Red Hen Lab](/blog/spending-this-summer-in-gsoc-with-red-hen-lab/)
 - [Week 1: Language Modeling](/blog/week-1-language-modeling/)
 - [Week 4: Acoustic Modeling](/blog/week-4-acoustic-modeling/)
 - [Week 5: Case HPC](/blog/week-5-case-hpc/)
 - [Week 7: Dialect Identification](/blog/week-7-dialect-identification/)
 - [Week 7 (Cont.): Arabic Speech Data](/blog/week-7-arabic-speech-data/)
 - [Week 8: Gale Arabic on Case HPC](/blog/week-8-gale-arabic-on-case-hpc/)
 - [Weeks 9 & 10: Dialect Identification Base](/blog/weeks-9-10-dialect-identification-base/)
